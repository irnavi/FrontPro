...
for(i = 0; i < arrImg.length; i++){
    images[i].src = arrImg[i].src;
    images[i].alt = arrImg[i].alt;
}
...
const arrItem = ['Item 1', 'Item 2', 'Item 3'];

const arrOfList = document.getElementsByTagName('li');
for(let i = 0; i < arrItem.length; i++ ){
  arrOfList[i].innerText = arrItem[i];
}